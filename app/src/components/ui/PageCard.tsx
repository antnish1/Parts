...
export function PageCard({ eyebrow, title, description, children }: PageCardProps) {
  ...
  return (
    <section className="rounded-xl border border-[#263244] bg-[#111827] p-3 shadow-panel">
      ...
      {displayTitle ? <h1 className={isNewOrderPage ? 'text-sm font-black uppercase tracking-[0.14em] text-[#0f4c81]' : 'mt-1 text-lg font-black text-white'}>{displayTitle}</h1> : null}
