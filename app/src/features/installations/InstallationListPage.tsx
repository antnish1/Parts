...
export function InstallationListPage() {
  ...
  const totals = useMemo(() => ({
    ...
    ACCEPTANCE_PENDING: entries.filter((e) => e.status === 'ACCEPTANCE_PENDING').length, ACCEPTED: entries.filter((e) => e.status === 'ACCEPTED').length,
  }), [entries]);
  ...
  const cards = [
    ['all','Total Entries',totals.all], ['PENDING','Pending',totals.PENDING], ['ACCEPTANCE_PENDING','Acceptance Pending',totals.ACCEPTANCE_PENDING], ['ACCEPTED','Accepted',totals.ACCEPTED],
  ] as const;
