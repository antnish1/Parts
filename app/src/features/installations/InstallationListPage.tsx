...
export function InstallationListPage() {
  const navigate = useNavigate(); const { profile } = useAuth(); const [params, setParams] = useSearchParams();
  ...
  const isViewer = profile?.id === INSTALLATION_VIEWER_PROFILE_ID;
