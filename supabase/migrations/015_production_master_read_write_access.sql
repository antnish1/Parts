...
drop policy if exists part_master_read_authenticated on public.part_master;
create policy part_master_read_authenticated
on public.part_master
for select
to authenticated
using (true);

drop policy if exists machine_master_read_authenticated on public.machine_master;
create policy machine_master_read_authenticated
on public.machine_master
for select
to authenticated
using (true);

drop policy if exists machine_master_insert_authenticated on public.machine_master;
create policy machine_master_insert_authenticated
on public.machine_master
for insert
to authenticated
with check (true);
